...
export const popover = tv({
  slots: {
    ...
    contentWrapper: `absolute bottom-0 right-0 size-0 transition-[width,height] duration-[var(--fade-content-duration)] ease-[steps(1,end)] group-hover:transition-none`,
